                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <Select
                          value={row.type}
                          onValueChange={(value) =>
                            setRowType(row.id, value as FilterType)
                          }
                        >
                          ...
                          <SelectContent className="max-h-[400px]">
                            ...
                            {/* Users object */}
                            <div key="users-header" className="px-2 py-1 text-xs font-semibold text-gray-900 mt-1">users</div>
                            ...
                            {/* Contacts object */}
                            <div key="contacts-header" className="px-2 py-1 text-xs font-semibold text-gray-900 mt-1">contacts</div>
